...
void *t_function(void *data)
{
	...
	while(1){
		...
		printf("PID(%d) utime = %u stime = %u PROCESS STATE = %c NAME = %s current sched = %d \n", pinfo->pid, pinfo->utime, pinfo->stime, pinfo->state, pinfo->exName, sched_getscheduler(pinfo->pid));
